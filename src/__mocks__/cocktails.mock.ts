 ...
 * Используются для тестирования функциональности размытия изображения и модального окна подтверждения возраста
 */
...
export const mockCocktailCategory: IMenuCategory = {
    ...
    labels: [],
    menu_items: [
        createCocktail('1', 'Негрони', 'Классический итальянский коктейль с джином, вермутом и кампари', 200, 1300),
        createCocktail('2', 'Маргарита', 'Мексиканский коктейль с текилой, лаймом и трипл-секом', 200, 1200),
        createCocktail('3', 'Мохито Классик', 'Освежающий коктейль с белым ромом, мятой и лаймом', 250, 1100),
        createCocktail('4', 'Вишневое наслаждение', 'Сладкий коктейль с вишней и виски', 200, 1400),
    ],
};
