...
export const banquetData: IBanquet = {
    banquet_options: [
        {
            ...
            service_fee: 10,
            max_duration: null,
            images: ['https://storage.yandexcloud.net/dreamteam-storage/3790ff7670bf4f1bb045cf2d37646bfa.jpg'],
            description: null,
        },
        {
            id: 15,
            ...
            service_fee: 10,
            max_duration: null,
            images: ['https://storage.yandexcloud.net/dreamteam-storage/14a57e50743c4cde8fe830afcf3ab938.jpg'],
            description: null,
        },
        {
            id: 16,
            ...
            service_fee: 10,
            max_duration: null,
            images: ['https://storage.yandexcloud.net/dreamteam-storage/f187c97f96ab43f8be1c34ff3eefac78.JPG'],
            description: null,
        },
    ],
    additional_options: [
    ...
    description:
        'Ваши значимые события в Smoke BBQ: банкеты, частные мероприятия, семейные торжества, корпоративные и деловые встречи',
};
...
export const mockBanquetOptionLongDescription: IBanquetOptions = {
    ...
    deposit_message: null,
    description:
        'Роскошный банкетный зал для проведения свадеб, юбилеев и корпоративных мероприятий. Панорамные окна с видом на город.',
    service_fee: 10,
    max_duration: null,
