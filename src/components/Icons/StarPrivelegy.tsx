...
export const StarPrivelegyIcon = ({ size = 24 }: IconProps) => {
    return (
        ...
        >
            ...
            <path d="M6.33057 3.9502L7.22758 5.14621" stroke="#B9B9B9" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M2.98975 14.2632L4.43848 13.8941" stroke="#B9B9B9" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M20.6362 14.2632L19.1875 13.8941" stroke="#B9B9B9" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M11.7876 19.5171L11.7876 20.5636" stroke="#B9B9B9" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M17.2441 3.9502L16.3471 5.14621" stroke="#B9B9B9" stroke-width="1.5" stroke-linecap="round"/>
        </svg>
    );
}
