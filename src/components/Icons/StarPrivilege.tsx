...
export const StarPrivilegeIcon = ({ size = 24, color = '#000000' }: IconProps) => {
    return (
        <svg width={size} height={size} viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                strokeWidth="1.5"
            />
            <path d="M6.33057 3.9502L7.22758 5.14621" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M2.98975 14.2632L4.43848 13.8941" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M20.6362 14.2632L19.1875 13.8941" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M11.7876 19.5171L11.7876 20.5636" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M17.2441 3.9502L16.3471 5.14621" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        </svg>
    );
};
