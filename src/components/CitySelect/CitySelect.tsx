...
export const CitySelect: FC<IConfirmationSelect> = ({ options, currentValue, onChange, titleStyle }) => {
    ...
    useEffect(() => {
        if (
            locationManager.openSettings.isAvailable() &&
                        ...
                        <div key={v.id} className={css.option} onClick={() => selectOnChange(v.id, v.text)}>
                            ...
                            <div
                                className={classNames(
                                    css.option_checkbox,
                                    currentValue.id == v.id ? css.option_checkbox__checked : null
                                )}
                            ></div>
                        </div>
                    ))}
