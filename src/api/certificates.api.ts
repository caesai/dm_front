...
export const APIPostCreateWithPayment = async (
    ...
    return axios.post(
        `${BASE_URL}/certificates/create-with-payment`,
        {
            user_id,
            certificate_type,
            value,
...
export const APIPutCertificateUpdate = async (token: string, certificate_id: string, certificate: ICertificate) => {
    return axios.put(
        `${ADMIN_URL}/certificates/${certificate_id}`,
        {
            ...certificate,
        },
        {
...
export const APIPostCertificateClaim = async (
    token: string,
    user_id: number,
    ...
    return axios.post(
        `${BASE_URL}/certificates/${certificate_id}/claim`,
        {
            certificate_id,
            user_id,
            recipient_name,
...
export const APIPostCertificateShare = async (
    token: string,
    certificate_id: string,
    recipient_id: number,
    message: string
    ...
    return axios.post(
        `${ADMIN_URL}/certificates/${certificate_id}/share`,
        {
            certificate_id,
            recipient_id,
            message,
...
export const APIPostCertificateCheckPayment = async (
    token: string,
    user_id: number,
    order_number: string,
    certificate_id: string
    ...
    return axios.post(
        `${BASE_URL}/alfabank/check-payment-status`,
        {
            order_number,
            user_id,
            certificate_id,
...
export const APIPostCreateAlfaPayment = async (token: string, user_id: number, amount: number) => {
    return axios.post(
        `${BASE_URL}/alfabank/create-payment`,
        {
            user_id,
            amount,
        },
 ...
 * @param promo_code - Промокод сертификата (dreamteam_id)
 */
export const APIPostEGiftCertificateInfo = async (api_token: string, promo_code: string) => {
