...
export const useBanquetForm = () => {
     ...
     */
    const setBanquetData = useCallback(
        (data: {
    ...
    const updateField = useCallback(
        (update: Partial<IBanquetFormState>) => {
            updateForm(update);
        },
        [updateForm]
    );
     ...
     */
    const createBanquetRequest = useCallback(
        async (commentary: string, contactMethod: string): Promise<boolean> => {
